<h2><a href="https://leetcode.com/problems/longest-subsequence-with-non-zero-bitwise-xor/">0</a></h2> <img src='https://img.shields.io/badge/Difficulty-Unknown-red' alt='Difficulty: Unknown' /><hr><p>You are given an integer array <code>nums</code>.</p>
